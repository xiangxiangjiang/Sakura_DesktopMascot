...
public class Rainity : MonoBehaviour
{
    ...
    public static void AddToStartup()
    {
        if (!Application.isEditor)
        {
            ...
            IWshShortcut shortcut = (IWshShortcut)shell.CreateShortcut(Environment.GetFolderPath(Environment.SpecialFolder.Startup) + "\\" + UnityEngine.Application.productName + ".lnk");
            shortcut.Description = "Startup shortcut for a " + UnityEngine.Application.productName + " application.";
    ...
    public static void RemoveFromStartup()
    {
        if (!Application.isEditor)
        {
            System.IO.File.Delete(Environment.GetFolderPath(Environment.SpecialFolder.Startup) + "\\" + UnityEngine.Application.productName + ".lnk");
        }
        else
        {
